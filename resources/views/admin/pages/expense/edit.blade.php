                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" readonly id="invoice_number" name="invoice_number" value="{{$editData->invoice_number}}" class="form-control">
                                </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="supplier_id" name="supplier_id" >
                                    <option value="{{$editData->supplier_id}}"> {{$editData->supplier_id}}</option>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="typeahead_1" onkeyup="return autocompletess(1)" name="product_name[]" value="{{$editData->product_name}}"  class="form-control typeahead">
